...
def main():
    input_path = 'fr_en/'
    ent_ill, train_ill, test_ill, index2rel, index2entity, rel2index, entity2index, rel_triples_1, rel_triples_2 = read_data(input_path)
    ...
    replace_space_with_tab(input_path + 'attr_triples_1', output_path + 'attr_triples_1')
    replace_space_with_tab(input_path + 'attr_triples_2', output_path + 'attr_triples_2')
    ...
    with open(file_path, 'r') as f:
        ...
        with open(output_path, 'w') as f:
            ...
            for row in reader:
                ...
                writer.writerow(filter(lambda x: x.strip() != '.' and x.strip() != '', row))
...
def read_data(data_path: str):
    ...
    return ent_ill, train_ill, test_ill, index2rel, index2entity, rel2index, entity2index, rel_triples_1, rel_triples_2
