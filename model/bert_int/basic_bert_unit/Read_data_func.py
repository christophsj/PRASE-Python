...
def read_data(data_path, des_dict_path=DES_DICT_PATH):
    def read_idtuple_file(file_path) -> list[tuple[int, int, int]]:
    ...
    def read_id2object(file_paths) -> dict[int, str]:
        id2object = {}
    ...
    def read_idobj_tuple_file(file_path) -> list[tuple[int, str]]:
