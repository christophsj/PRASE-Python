...
def get_neightview_and_desview_interaction_feature(input_data: BertIntInput, ent_emb, entity_pairs):
    print("----------------get neighbor view and description/name view interaction feature--------------------")
    cuda_num = CUDA_NUM
    rel_triples_1 = input_data.rel_triples_1
    rel_triples_2 = input_data.rel_triples_2

    train_ill = input_data.train_ill
    test_ill = input_data.test_ill

    index2entity = input_data.index2entity
    ...
    return neighViewInterF, desViewInterF
